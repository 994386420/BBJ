...
public class TRMenuAdapter extends RecyclerView.Adapter<TRMenuAdapter.TRMViewHolder> {
    ...
    public void onBindViewHolder(TRMViewHolder holder, int position) {
        ...
        if (menuItem.getMsgtext() != null && !menuItem.getMsgtext().equals("0")) {
            holder.mestext.setVisibility(View.VISIBLE);
            holder.mestext.setText(menuItem.getMsgtext());
        }else {
            holder.mestext.setVisibility(View.GONE);
        }
        if (position == 0){
    ...
    class TRMViewHolder extends RecyclerView.ViewHolder{
        ...
        TRMViewHolder(View itemView) {
            ...
            mestext = itemView.findViewById(R.id.mnewmsg);
        }
    }
