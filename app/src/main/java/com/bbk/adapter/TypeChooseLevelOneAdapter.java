...
public class TypeChooseLevelOneAdapter extends BaseAdapter {

	private Context mContext;
	private List<TypesChooseLevelOneBean> titlelist;
	private int clickTemp = -1;

	public TypeChooseLevelOneAdapter(Context context,
                                     List<TypesChooseLevelOneBean> titlelist) {
