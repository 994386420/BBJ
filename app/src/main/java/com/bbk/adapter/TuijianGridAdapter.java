...
public class TuijianGridAdapter extends RecyclerView.Adapter {
    //    private List<Map<String,String>> list;
    private Context context;
    List<ShopTuijianBean> shopTuijianBeans;

    public TuijianGridAdapter(Context context, List<ShopTuijianBean> shopTuijianBeans) {
//        this.list = list;
        this.context = context;
        this.shopTuijianBeans = shopTuijianBeans;
    }
    ...
    public int getItemCount() {
        return shopTuijianBeans.size();
    }

    public void notifyData(List<ShopTuijianBean> beans) {
        this.shopTuijianBeans.addAll(beans);
