...
public class DianPuHoHotGridAdapter extends RecyclerView.Adapter {
    //    private List<Map<String,String>> list;
    private Context context;
    List<ShopDianpuBean> shopDianpuBeans;

    public DianPuHoHotGridAdapter(Context context, List<ShopDianpuBean> shopDianpuBeans) {
//        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHolder ViewHolder = new ViewHolder(
                LayoutInflater.from(context).inflate(R.layout.dianpu_hot_item, parent, false));
        return ViewHolder;
    }
