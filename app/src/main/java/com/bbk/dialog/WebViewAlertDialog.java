...
import com.bbk.util.TaobaoLoginUtil;
...
public class WebViewAlertDialog {
	...
	private void initView(View view, boolean ishis) {
		mlistview1 = (MyListView) view.findViewById(R.id.mlistview1);
		mlistview2 = (MyListView) view.findViewById(R.id.mlistview2);
		...
		android.view.ViewGroup.LayoutParams params = mwebview.getLayoutParams();
