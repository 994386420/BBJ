...
public class X5CarWebView extends WebView {
	TextView title;
	...
	public X5CarWebView(Context arg0, AttributeSet arg1) {
		super(arg0, arg1);
		this.setWebViewClient(client);
		// this.setWebChromeClient(chromeClient);
		// WebStorage webStorage = WebStorage.getInstance();
		progressbar = new ProgressBar(arg0, null,
...
//	}
	...
	public X5CarWebView(Context arg0) {
		super(arg0);
