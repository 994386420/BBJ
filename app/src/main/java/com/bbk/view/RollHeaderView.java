...
public class RollHeaderView extends FrameLayout implements OnPageChangeListener {
    ...
    public RollHeaderView(Context context,float height,boolean isScale) {
        this(context, null,0,height,isScale);
    }

    public RollHeaderView(Context context, AttributeSet attrs, int defStyle,float height,boolean isScale) {
    ...
    private class MyAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            iv.setOnTouchListener(new OnTouchListener() {
				...
				//加载图片
	            Glide.with(mContext)
	    		.load(mUrlList.get(position % mUrlList.size()))//mUrlList.size()他的長度為0 你檢查一下
	            .placeholder(R.mipmap.zw_img_1242_banner)
