...
//	private int topLayoutheight = 0;
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		params.height = getMeasuredHeight() - mNav.getMeasuredHeight() - bottomLayoutheight;
	}
...
//			mTopViewHeight = mTopViewHeight - (getMeasuredHeight() - bottomLayoutheight);
			mTopViewHeight = mTopViewHeight - getMeasuredHeight();
		}
	}
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if(null == mInnerScrollView) {
				if (isTopHidden && dy > 0 && !isInControl) {
					isInControl = true;
