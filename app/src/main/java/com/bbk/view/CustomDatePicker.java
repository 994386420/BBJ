...
//                minuteChange();
    ...
    private boolean isValidDate(String date, String template) {
        ...
        try {
            // 璁剧疆lenient涓篺alse. 鍚﹀垯SimpleDateFormat浼氭瘮杈冨鏉惧湴楠岃瘉鏃ユ湡锛屾瘮濡�2015/02/29浼氳鎺ュ彈锛屽苟杞崲鎴�2015/03/01
