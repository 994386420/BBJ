...
//    private static int DEFAULT_TOUCH_TARGET_SIZE = Math.round(DensityUtil.dip2px(mContext, 40));
    ...
    public MaterialRangeSlider(Context context) {
        super(context);
        mContext = context;
        DEFAULT_TOUCH_TARGET_SIZE = Math.round(DensityUtil.dip2px(mContext, 40));
        init(null);
    }
    ...
    private void getDefaultMeasurements() {
        pressedRadius = Math.round(DensityUtil.dip2px(mContext, DEFAULT_PRESSED_RADIUS));
        unpressedRadius = Math.round(DensityUtil.dip2px(mContext, DEFAULT_UNPRESSED_RADIUS));
        insideRangeLineStrokeWidth = Math.round(DensityUtil.dip2px(mContext, DEFAULT_INSIDE_RANGE_STROKE_WIDTH));
        outsideRangeLineStrokeWidth = Math.round(DensityUtil.dip2px(mContext, DEFAULT_OUTSIDE_RANGE_STROKE_WIDTH));
    }
