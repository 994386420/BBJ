...
public class HomeGridAdapter extends RecyclerView.Adapter {
    ...
    public HomeGridAdapter(Context context, List<MiaoShaBean> miaoShaBeans) {
//        this.list = list;
            ...
            viewHolder.resultItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (TextUtils.isEmpty(userID)) {
                        logInterface.IntentLog(miaoShaBean.getUrl(), miaoShaBean.getTitle(),miaoShaBean.getDomain(),"0",miaoShaBean.getBprice(),miaoShaBean.getQuan(),miaoShaBean.getZuan(),"miaosha");
                    } else {
